...
impl Setup {
    ...
    pub fn new_ic_agent_runtime(&self) -> CyclesWalletRuntime<AgentRuntime> {
        CyclesWalletRuntime::new(AgentRuntime::new(&self.agent), self.wallet_canister_id)
    }

    pub fn client_builder(&self) -> ClientBuilder<CyclesWalletRuntime<AgentRuntime>> {
        SolRpcClient::builder(self.new_ic_agent_runtime(), self.sol_rpc_canister_id)
    }

    pub fn client(&self) -> SolRpcClient<CyclesWalletRuntime<AgentRuntime>> {
        self.client_builder()
