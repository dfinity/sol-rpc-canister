// TODO XC-297: Once the new feature flag is merged in the upstream `agave-xyz/solana-sdk repository`
...
// TODO XC-297: Replace usages with call to `transfer` method in `spl-token` crate.
/// Creates an instruction to run the
/// [`Transfer`](https://github.com/solana-program/token/blob/4c3fabd685e30b27bbc8f5d515626177dd720a02/interface/src/instruction.rs#L98)
/// instruction in the SPL Token program.
///
/// This implementation was taken from the `spl-token` crate
/// [here](https://github.com/solana-program/token/blob/4c3fabd685e30b27bbc8f5d515626177dd720a02/program/src/instruction.rs#L964)
/// to force usage of the DFINITY forks for the Solana SDK crates.
