...
use sol_rpc_types::{InstallArgs, ProviderId, RpcAccess, RpcAuth, SolanaCluster};
...
mod get_provider_tests {
    ...
    async fn should_get_providers() {
        ...
        assert_eq!(
            providers[0],
            (
                (ProviderId::Alchemy, SolanaCluster::Mainnet),
...
mod update_api_key_tests {
    ...
    async fn should_update_api_key() {
        ...
        let provider = (ProviderId::Alchemy, SolanaCluster::Mainnet);
    ...
    async fn should_prevent_unauthenticated_update_api_keys() {
        ...
        setup
            ...
            .with_caller(setup.controller())
            .update_api_keys(&[(
                (ProviderId::PublicNode, SolanaCluster::Mainnet),
